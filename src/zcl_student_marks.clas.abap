CLASS zcl_student_marks DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_STUDENT_MARKS IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

   DATA: lt_student TYPE STANDARD TABLE OF zuk_student WITH EMPTY KEY,
          lt_marks TYPE STANDARD TABLE OF zuk_marks WITH EMPTY KEY,
    ...
    TRY.
       ...
       ( student_id = 'S0002' student_name = 'Alice Smith'    age = '14' class = '09' class_section = 'B' avg_marks = '82.30' )
        ...
        DELETE FROM zuk_student.
        INSERT zuk_student FROM TABLE @lt_student.
        ...
        DELETE FROM zuk_marks.
        INSERT zuk_marks FROM TABLE @lt_marks.
